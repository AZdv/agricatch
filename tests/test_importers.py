...
def test_undated_url_is_fetched_once_regardless_of_days() -> None:
...
def test_dated_url_expands_one_entry_per_step() -> None:
    class Dated(Website):
...
def test_missing_child_xpath_is_reported() -> None:
